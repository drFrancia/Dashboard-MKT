...
CREDENTIALS_PATH = r"E:\Users\franco.insfran\Desktop\Dashboard_DB\config\credentials.json"  # Ruta a tu archivo JSON de credenciales
...
# 🧪 MODO DE PRUEBA - Limitar cantidad de archivos a procesar
TEST_MODE = True  # Cambiar a False para procesar todos los archivos
MAX_FILES_TEST = 3  # Número de archivos a procesar en modo prueba
...
def main():
    ...
    if TEST_MODE:
        ...
        print(f"⚠️  Solo se procesarán {MAX_FILES_TEST} archivos")
        files = files[:MAX_FILES_TEST]
        print(f"✅ Archivos seleccionados para prueba: {len(files)}\n")
