...
#         sessions,
#         screenPageViews,
#         ROUND(bounceRate * 100, 2) as bounceRate,
...
def main_dashboard():
    ...
    with st.sidebar:
        ...
        if available_dates:
            ...
            # NUEVO: Filtro de rango de fechas con calendario
            ...
            with col2:
                fecha_fin = st.date_input(
                    "📅 Fecha Fin:",
                    value=default_end,
                    min_value=fecha_inicio,  # No puede ser anterior a fecha_inicio
                    max_value=max_date,
            ...
            dias_seleccionados = dias_disponibles  # Usar los días realmente disponibles
            
            col_info1, col_info2, col_info3 = st.columns(3)
            
            # with col_info1:
            #     st.metric("📊 Días en rango", dias_totales)
            
            # with col_info2:
            #     st.metric("✅ Días disponibles", dias_disponibles)
            
            # with col_info3:
            #     cobertura = (dias_disponibles / dias_totales) * 100
            ...
            # # Botón para todos los datos
            # if st.button("📈 Todos los datos disponibles", use_container_width=True):
    ...
    <div class="date-filter-card">
        ...
        <p><strong>Cobertura:</strong> {dias_disponibles} de {dias_totales} día(s) ({(dias_disponibles/dias_totales)*100:.1f}% de datos disponibles)</p>
    </div>
    """, unsafe_allow_html=True)
