...
def create_geo_summary_table(df_geo):
    ...
    df_geo_summary['Páginas por Usuario'] = (df_geo_summary['Páginas Vistas'] / df_geo_summary['activeUsers']).round(2)
    df_geo_summary['Sesiones por Usuario'] = (df_geo_summary['Sesiones'] / df_geo_summary['activeUsers']).round(2)
...
def main_dashboard():
    ...
    # =============================================================================
    # 📊 3. VER DATOS DETALLADOS (NUEVA POSICIÓN)
    # =============================================================================
    ...
    # =============================================================================
    # 📄 4. PÁGINAS MÁS VISITADAS (NUEVA POSICIÓN)
    # =============================================================================
    ...
    # =============================================================================
    # 📱 5. ANÁLISIS POR DISPOSITIVOS (NUEVA POSICIÓN)
    # =============================================================================
    ...
    # =============================================================================
    # 📈 6. TENDENCIA DIARIA (NUEVA POSICIÓN)
    # =============================================================================
    ...
    # =============================================================================
    # 🌍 ANÁLISIS GEOGRÁFICO (MANTIENE POSICIÓN ORIGINAL)
    # =============================================================================
    ...
    # =============================================================================
    # ⏰ ANÁLISIS POR HORAS (MANTIENE POSICIÓN ORIGINAL)
    # =============================================================================
